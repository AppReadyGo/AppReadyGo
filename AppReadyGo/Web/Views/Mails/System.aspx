...
Inherits="System.Web.Mvc.ViewPage<AppReadyGo.Model.Mails.SystemEmailModel>" %>
                                ...
                                <table border="0" cellpadding="40" cellspacing="0" width="100%">
                                    <tbody><tr>
                                        <td align="left" style="border-collapse:collapse">
                                            ...
                                            <a href="<%:Model.SiteRootUrl %>" style="color:#336699;font-weight:normal;text-decoration:underline" target="_blank"><img src="<%:Model.SiteRootUrl %>/Content/images/Logo173X38.png"" width="173" height="38" align="" border="0" title="AppReadyGo" alt="AppReadyGo" style="border:0;min-height:auto;line-height:100%;outline:none;text-decoration:none;display:inline;margin-bottom:0px"></a>
                                            </div>
                                        </td>
                                    </tr>
                                </tbody></table>
