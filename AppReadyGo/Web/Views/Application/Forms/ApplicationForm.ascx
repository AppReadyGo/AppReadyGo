<%@ Control Language="C#" Inherits="System.Web.Mvc.ViewUserControl<AppReadyGo.Model.Pages.Application.ApplicationModel>" %>
...
<%} %>
<div id="sample_code">
    <%if (!ViewBag.Edit || Model.Type == (int)AppReadyGo.Common.Entities.ApplicationType.Web){ %>
    ...
    <%} %>
    <%if (!ViewBag.Edit || Model.Type == (int)AppReadyGo.Common.Entities.ApplicationType.Android) { %>
    <div id="sample_android_code" class="step">
        ...
        <div>Properties: <a id="properties_lnk" href="/Properties/<%:(int)AppReadyGo.Common.Entities.ApplicationType.Android %>/<%: Model.PortfolioId %>/<%: ViewBag.Edit ? Model.Id.ToString() : "{appId}" %>/fingerprint.properties">Android Properties <%: ViewBag.Version %> <strong>Download</strong></a></div>
