...
ALTER TABLE [dbo].[SurveyQuestion]  ADD  CONSTRAINT [FK_SurveyQuestion_Question] FOREIGN KEY([QuestionId])
...
ALTER TABLE [dbo].[SurveyQuestion]  ADD  CONSTRAINT [FK_SurveyQuestion_Survey] FOREIGN KEY([SurveyId])
