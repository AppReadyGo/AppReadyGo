...
(2/*User*/, 'test@appreadygo.com', 'XW0mA5DzfN4XL851H/i1xNFFbMOdtjVAL6fjBN5monE='/*111111*/, '/WCjbQ==',  GETDATE(), 1, 'Test', 'User', 0, 1, (select [ID] from [usr].[Memberships] where Name = 'Pro'), 1, 0),
(3/*App User*/, 'testapp@appreadygo.com', 'XW0mA5DzfN4XL851H/i1xNFFbMOdtjVAL6fjBN5monE='/*111111*/, '/WCjbQ==',  GETDATE(), 1, 'App', 'User', 0, 1, (select [ID] from [usr].[Memberships] where Name = 'Pro'), 1, 0);
